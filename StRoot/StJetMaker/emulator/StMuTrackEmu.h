...
public:
  ...
  StMuTrackEmu()
    ...
    , _id(0)
    , _detectorId(0)
    , _btofTrayId(0)        // bassam
    , _nSigmaTofPion(0)     // bassam
    , _nSigmaTofKaon(0)     // bassam
    , _nSigmaTofProton(0)   // bassam
    , _nSigmaTofElectron(0) // bassam
 { }
  ...
  unsigned char  matchFlag()   const { return _matchFlag; }
