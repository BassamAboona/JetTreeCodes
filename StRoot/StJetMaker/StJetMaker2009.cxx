...
{
  StJetCandidate* jet = event->newJet(vertex->position(),TLorentzVector(protojet.px(),protojet.py(),protojet.pz(),protojet.e()),static_cast<float>(protojet.area()), static_cast<float>(protojet.areaError()), static_cast<float>(protojet.vecAreaPx()), static_cast<float>(protojet.vecAreaPy()), static_cast<float>(protojet.vecAreaPz()), static_cast<float>(protojet.vecAreaE()));
  vertex->addJet(jet);
