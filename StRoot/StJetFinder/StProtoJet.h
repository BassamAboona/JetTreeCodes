...
public:
 ...
 //area
  ...
  double vecAreaPx() const {return mVecAreaPx;}
  double vecAreaPy() const {return mVecAreaPy;}
  double vecAreaPz() const {return mVecAreaPz;}
  double vecAreaE() const {return mVecAreaE;}

  void setArea(double area) { mArea = area;}
  void setVecArea(double VecAreaPx, double VecAreaPy, double VecAreaPz, double VecAreaE) { mVecAreaPx = VecAreaPx; mVecAreaPy = VecAreaPy; mVecAreaPz = VecAreaPz; mVecAreaE = VecAreaE;}
  //area error
