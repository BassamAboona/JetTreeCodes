...
public:
  ...
  StJetCandidate(const TVector3& vertex, const TLorentzVector& fourMomentum, float area = 0, float area_error = 0, float vecAreaPx=0, float vecAreaPy=0, float vecAreaPz=0, float vecAreaE=0);

  TLorentzVector fourMomentum() const;
  TLorentzVector areafourMomentum() const;
  ...
  float vecAreaPx() const{ return mVecAreaPx; }
  float vecAreaPy() const{ return mVecAreaPy; }
  float vecAreaPz() const{ return mVecAreaPz; }
  float vecAreaE() const{ return mVecAreaE; }
  ...
  void setUeMDensity(const char* name, float Mdensity){ string str(name); mUeMDensity[str] = Mdensity; }
  ...
  map<string, float> ueMDensity() const { return mUeMDensity; }
