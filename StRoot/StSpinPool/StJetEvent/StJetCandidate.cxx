...
StJetCandidate::StJetCandidate(const TVector3& vertex, const TLorentzVector& fourMomentum, float area, float area_error, float vecAreaPx, float vecAreaPy, float vecAreaPz, float vecAreaE)
  : mPt(fourMomentum.Pt())
  ...
  , mVecAreaPx(vecAreaPx)
  , mVecAreaPy(vecAreaPy)
  , mVecAreaPz(vecAreaPz)
  , mVecAreaE(vecAreaE)
{
