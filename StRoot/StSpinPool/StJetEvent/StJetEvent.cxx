...
StJetCandidate* StJetEvent::newJet(const TVector3& vertex, const TLorentzVector& fourMomentum, float area, float area_error, float vecAreaPx, float vecAreaPy, float vecAreaPz, float vecAreaE) { return new ((*mJets)[mJets->GetEntriesFast()]) StJetCandidate(vertex,fourMomentum, area, area_error, vecAreaPx, vecAreaPy, vecAreaPz, vecAreaE); }
