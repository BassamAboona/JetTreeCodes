...
public:
  ...
  StJetCandidate* newJet     (const TVector3& vertex, const TLorentzVector& fourMomentum, float area = 0, float area_error = 0, float vecAreaPx =0, float vecAreaPy = 0, float vecAreaPz = 0, float vecAreaE = 0);
  StJetTrack*     newTrack   ();
  StJetTower*     newTower   ();
