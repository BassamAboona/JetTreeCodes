...
StJetSkimEvent::StJetSkimEvent(const StJetSkimEvent &other) : TObject()
{
    ...
    this->mNVpdEGoodHits = other.nVpdEGoodHits();
    this->mNVpdWGoodHits = other.nVpdWGoodHits();
...
StJetSkimEvent& StJetSkimEvent::operator=(const StJetSkimEvent &rhs) 
{
    if(this != &rhs) {
        ...
        this->mNVpdEGoodHits = rhs.nVpdEGoodHits();
        this->mNVpdWGoodHits = rhs.nVpdWGoodHits();
